	...
	public void moveUp() {
		...
		try {
			...
			if (!isCandy) {
				...
				int indexnum = ((int) (Math.random() * DrawingSurface.ss.size()));
				String fileName = (String) JOptionPane.showInputDialog(DrawingSurface.w,
						"What is " + DrawingSurface.ss.getTermAt(indexnum) + " in " + DrawingSurface.ss.getName() + "?",
	...
	public void moveRight() {
		...
		try {
			...
			if (!isCandy) {
				...
				DrawingSurface.pausee(true);
				System.out.println("asdf");
				int indexnum = ((int) (Math.random() * DrawingSurface.ss.getSet().size()));
				String fileName = (String) JOptionPane.showInputDialog(DrawingSurface.w,
						"What is " + DrawingSurface.ss.getTermAt(indexnum) + " in " + DrawingSurface.ss.getName() + "?",
						"Question", JOptionPane.PLAIN_MESSAGE, null, null, "");
